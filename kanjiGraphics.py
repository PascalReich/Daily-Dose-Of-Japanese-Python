...
#Heisig Meanings
HeisigEs = {'晶': 'destello', '七': 'siete', '朋': 'compañera', '古': 'viejo', '月': 'mes', '九': 'nueve', '八': 'ocho', '吾': 'yo', '二': 'dos', '昌': 'próspero', '早': 'temprano', '五': 'cinco', '一': 'uno', '六': 'seis', '田': 'campo de arroz', '冒': 'riesgo', '口': 'boca', '十': 'diez', '呂': 'espina dorsal', '明': 'claro', '三': 'tres', '品': 'mercancías', '目': 'ojo', '唱': 'canto', '旭': 'sol naciente', '世': 'generación', '四': 'cuatro', '日': 'día', '占': 'adivinación', '亘': 'atravesar', '下': 'abajo', '升': 'caja para medir', '千': 'mil', '貝': 'almeja', '朝': 'mañana', '博': 'Dr.', '自': 'uno mismo', '胃': 'estómago', '寸': 'medida', '専': 'especialidad', '胆': 'vesícula biliar', '百': 'cien', '昇': 'elevarse', '只': 'único', '凸': 'convexo', '舌': 'lengua', '凹': 'cóncavo', '丸': 'redondo', '旧': 'antigüedad', '中': 'en', '旦': 'amanecer', '貞': 'recto', '白': 'blanco', '卓': 'eminente', '上': 'arriba', '見': 'ver', '旬': 'decamerón', '勺': 'cucharón', '的': 'diana', '直': 'directamente', '乙': 'entrañas de pescado', '左': 'izquierda', '乱': 'tumulto', '員': 'empleado', '凡': 'mediocre', '肌': 'piel', '真': 'verdad', '元': 'principio', '負': 'derrota', '項': 'párrafo', '賄': 'soborno', '貢': 'tributo', '有': 'posesión', '工': 'técnica', '具': 'herramienta', '首': 'cuello', '万': 'diez mil', '頑': 'tozudo', '句': 'frase', '児': 'recién nacido', '頁': 'página', '右': 'derecha', '刀': 'espada', '多': 'muchos', '母': 'madre', '如': 'parecido', '大': 'grande', '可': 'posible', '別': 'separar', '外': 'exterior', '刃': 'filo', '子': 'niño', '町': 'barrio', '夕': 'noche', '克': 'superar', '召': 'seducir', '丁': 'calle', '女': 'mujer', '了': 'acabado', '切': 'cortar', '頂': 'cima', '汐': 'marea nocturna', '則': 'norma', '副': 'vice-', '貫': 'traspasar', '好': 'gustar', '少': 'poco', '孔': 'Confucio', '兄': 'hermano mayor', '小': 'pequeño', '昭': 'brillante', '砂': 'arena', '厚': 'grueso', '器': 'utensilio', '硝': 'nitrato', '肖': 'semejanza', '光': 'rayo', '順': 'obedecer', '沼': 'pantano', '原': 'prado', '臭': 'apestar', '氷': 'hielo', '太': 'gordo', '省': 'reflexionar', '願': 'petición', '泉': 'manantial', '永': 'eternidad', '水': 'agua', '州': 'estado', '石': 'piedra', '名': 'nombre', '削': 'cepillar', '沖': 'alta mar', '奇': 'extraño', '川': 'arroyo', '妙': 'exquisita', '砕': 'aplastar', '泳': 'nadar', '活': 'animado', '埼': 'cabo', '潮': 'marea', '畑': 'plantación', '圭': 'joya cuadrada', '況': 'por supuesto', '消': 'extinguir', '測': 'sondear', '灯': 'lámpara', '涯': 'horizonte', '汁': 'sopa', '河': 'río', '土': 'tierra', '均': 'anivelado', '江': 'riachuelo', '泊': 'pernoctar', '炎': 'inflamación', '淡': 'diluido', '寺': 'templo budista', '吐': 'escupir', '時': 'tiempo', '湖': 'lago', '煩': 'angustia', '垣': 'valla', '火': 'fuego', '源': 'origen', '圧': 'presión', '封': 'sellar', '尚': 'estimado', '照': 'iluminar', '胴': 'tronco', '安': 'relajo', '墨': 'tinta china', '洞': 'cueva', '厘': 'rin', '里': 'ri', '埋': 'enterrar', '宴': 'banquete', '漁': 'pescar', '宣': 'proclamar', '守': 'proteger', '字': 'letra', '量': 'cantidad', '完': 'perfecto', '同': 'el mismo', '点': 'punto', '宵': 'anochecer', '鯉': 'carpa', '魚': 'pescado', '黒': 'negro', '向': 'en frente de', '灰': 'ceniza', '富': 'riqueza', '寄': 'acercarse', '災': 'desastre', '味': 'sabor', '桂': 'katsura', '桐': 'paulonia', '暦': 'calendario', '柏': 'roble', '末': 'extremo', '相': 'inter-', '枠': 'marco', '村': 'pueblo', '妹': 'hermana menor', '木': 'árbol', '貯': 'ahorros', '枯': 'marchitado', '杏': 'albaricoque', '札': 'etiqueta', '朴': 'bruto', '森': 'bosque', '机': 'escritorio', '未': 'todavía', '植': 'plantar', '棚': 'estantería', '林': 'arboleda', '案': 'plan', '燥': 'agostar', '沫': 'salpicadura', '朱': 'carmesí', '梢': 'copa del árbol', '本': 'libro', '株': 'acciones de bolsa', '荻': 'caña', '葉': 'hoja', '苗': 'plantón', '模': 'imitación', '薄': 'desteñido', '暮': 'ganarse la vida', '黙': 'silencio', '眺': 'mirar fijamente', '状': 'statu quo', '兆': 'augurio', '寛': 'tolerancia', '特': 'especial', '先': 'antes', '狩': 'cazar', '漠': 'borroso', '告': 'revelación', '然': 'tal como es', '猫': 'gato', '膜': 'membrana', '洗': 'lavar', '牛': 'vaca', '桃': 'melocotón', '犬': 'perro', '若': 'juventud', '苦': 'sufrimiento', '墓': 'tumba', '草': 'hierba', '呈': 'ofrenda', '茶': 'té', '道': 'camino', '界': 'mundo', '全': 'todo', '鉢': 'bol', '金': 'oro', '鎮': 'tranquilizar', '柱': 'columna', '理': 'lógica', '銅': 'cobre', '狂': 'loco', '介': 'apretado', '皇': 'emperador', '銘': 'inscripción', '合': 'encajar', '注': 'verter', '針': 'aguja', '塔': 'pagoda', '王': 'rey', '現': 'presente', '珠': 'perla', '宝': 'tesoro', '主': 'amo', '玉': 'joya', '釣': 'pescar con caña', '導': 'guiar', '栓': 'tapón', '銑': 'lingote', '落': 'caer', '迫': 'apremiar', '輝': 'radiante', '連': 'acompañar', '高': 'alto', '夏': 'verano', '逃': 'escapar', '輸': 'transportar', '巡': 'patrullar', '造': 'crear', '客': 'invitado', '軍': 'ejército', '処': 'deshacerse de', '冠': 'corona', '略': 'abreviatura', '享': 'recibir', '軌': 'carril', '格': 'categoría', '夢': 'sueño', '坑': 'foso', '迅': 'veloz', '辻': 'cruce', '辺': 'inmediaciones', '条': 'ramita', '前': 'delante', '冗': 'superfluo', '各': 'cada uno', '額': 'frente', '運': 'llevar', '車': 'carruaje', '警': 'amonestar', '週': 'semana', '景': 'paisaje', '敗': 'fracaso', '敬': 'respeto', '津': 'ensenada', '舎': 'casa de campo', '京': 'capital', '覚': 'memorizar', '故': 'casualidad', '栄': 'florecer', '周': 'circunferencia', '壮': 'robusto', '牧': 'criar', '枚': 'hojas de', '売': 'venta', '吉': 'buena suerte', '獄': 'cárcel', '言': 'decir', '鯨': 'ballena', '学': 'estudiar', '熟': 'madurar', '士': 'hidalgo', '塾': 'academia de repaso', '攻': 'agresión', '訂': 'revisión', '計': 'proyecto', '荘': 'chalet', '涼': 'refrescante', '亭': 'pabellón', '書': 'escribir', '語': 'palabra', '滅': 'destruir', '詰': 'atascado', '談': 'discusión', '成': 'convertirse', '読': 'leer', '諭': 'reproche', '賊': 'bandido', '詔': 'edicto imperial', '浅': 'poco profundo', '栽': 'plantío', '調': 'afinar', '域': 'zona', '茂': 'exuberante', '桟': 'andamio', '減': 'menguar', '式': 'estilo', '威': 'intimidar', '討': 'reprender', '詠': 'recitar', '城': 'castillo', '諾': 'consentimiento', '銭': 'moneda', '弐': 'ii (dos)', '訓': 'instrucción', '誠': 'sincero', '詩': 'poesía', '試': 'examen', '載': 'cargar', '話': 'hablar', '錠': 'cerradura', '頻': 'repetidamente', '題': 'tema', '衣': 'ropa', '歴': 'curriculum', '定': 'determinación', '赴': 'proceder', '装': 'atuendo', '止': 'detenerse', '誕': 'natividad', '正': 'correcto', '企': 'emprender', '裏': 'reverso', '証': 'certificación', '歩': 'andar', '越': 'adelantar', '壊': 'demolición', '賦': 'recaudación', '走': 'correr', '渉': 'vadear', '肯': 'acuerdo', '婿': 'novio', '建': 'construir', '延': 'prolongar', '政': 'política', '超': 'sobrepasar', '裁': 'confeccionar', '武': 'guerrero', '礎': 'piedra angular', '堤': 'dique', '是': 'debidamente', '遠': 'distante', '制': 'sistema', '滞': 'estancado', '芸': 'destreza', '天': 'cielo', '幅': 'rollo colgante', '製': 'made in', '錦': 'brocado', '帽': 'sombrero', '市': 'mercado', '布': 'tela', '姉': 'hermana mayor', '肺': 'pulmones', '霜': 'escarcha', '雷': 'trueno', '初': 'primera vez', '転': 'girar', '帯': 'faja', '猿': 'mono', '帆': 'vela', '幕': 'cortina', '曇': 'nublado', '冬': 'invierno', '哀': 'patético', '幌': 'baldaquín', '雲': 'nube', '雨': 'lluvia', '刺': 'espina', '混': 'mezclar', '匕': 'cuchara', '喝': 'ronco', '立': 'en pie', '章': 'insignia', '鐘': 'campana', '謁': 'audiencia', '帝': 'soberano', '北': 'norte', '皆': 'todos', '褐': 'marrón', '童': 'juvenil', '嫡': 'esposa legítima', '瞳': 'pupila', '泣': 'llorar', '昆': 'descendientes', '適': 'apropiado', '滴': 'gotear', '嬌': 'atractiva', '比': 'comparar', '競': 'disputar', '背': 'estatura', '脂': 'grasa', '橋': 'puente', '旨': 'delicioso', '商': 'hacer un trato', '渇': 'sed', '敵': 'enemigo', '識': 'perspicaz', '腹': 'abdomen', '鏡': 'espejo', '歌': 'canción', '欠': 'carencia', '毎': 'todos los', '乞': 'mendigar', '亡': 'difunto', '資': 'bienes', '諮': 'consultar', '炊': 'cocinar', '次': 'siguiente', '軟': 'blando', '梅': 'ciruela', '姿': 'figura', '複': 'duplicar', '茨': 'zarza', '乾': 'sequía', '敏': 'astucia', '暗': 'oscuridad', '海': 'mar', '壱': 'i (uno)', '剖': 'dividir', '培': 'cultivar', '境': 'límite', '音': 'sonido', '賠': 'compensación', '吹': 'soplar', '韻': 'rima', '坊': 'chiquillo', '県': 'prefectura', '歳': 'fin de año', '激': 'violento', '鋭': 'afilado', '荒': 'arrasado', '賓': 'V.I.P.', '妊': 'embarazada', '凍': 'helado', '望': 'ambición', '妄': 'ilusión', '方': 'dirección', '放': 'liberar', '染': 'teñir', '曽': 'anteriormente', '棟': 'caballete', '贈': 'regalo', '訪': 'visitar', '増': 'aumento', '説': 'rumor', '芳': 'perfumado', '東': 'este', '燃': 'quemar', '盲': 'ciego', '脱': 'desnudarse', '廷': 'tribunal', '妨': 'obstaculizar', '肪': 'obeso', '起': 'despertar, levantarse', '竜': 'dragón', '逐': 'cumplir', '栃': 'castaña de Indias', '風': 'viento', '豚': 'puerco', '池': 'estanque', '虫': 'insecto', '電': 'electricidad', '包': 'envolver', '地': 'terreno', '記': 'escriba', '滝': 'catarata', '蚕': 'gusano de seda', '蛇': 'serpiente', '独': 'solitario', '蛍': 'luciérnaga', '蝶': 'mariposa', '砲': 'cañón', '亀': 'tortuga de tierra', '虹': 'arco iris', '遂': 'consumar', '己': 'el yo', '胞': 'placenta', '泡': 'burbuja', '妃': 'reina', '改': 'reforma', '進': 'avanzar', '鮮': 'fresco', '差': 'distinción', '美': 'belleza', '奪': 'arrebatar', '湯': 'agua caliente', '洋': 'océano', '詳': 'detallado', '集': 'reunir', '雑': 'varios', '羊': 'oveja', '確': 'seguro', '礁': 'arrecife', '着': 'vestirse', '達': 'hábil', '羨': 'envidia', '焦': 'chamuscar', '場': 'lugar', '准': 'cuasi-', '腸': 'intestinos', '奮': 'excitado', '雌': 'hembra', '家': 'casa', '唯': 'sólo', '嫁': 'novia', '豪': 'abrumador', '準': 'semi-', '床': 'cama', '歓': 'deleite', '庫': 'garaje', '習': 'aprender', '午': 'mediodía', '曜': 'día de la semana', '心': 'corazón', '店': 'tienda', '忘': 'olvidar', '翌': 'subsecuente', '壇': 'podio', '回': 'veces', '困': 'apuro', '固': 'duro', '国': 'país', '観': 'panorama', '曰': 'dixit', '園': 'parque', '団': 'grupo', '権': 'autoridad', '姻': 'matrimonio', '麻': 'cáñamo', '庭': 'patio', '羽': 'plumas', '庁': 'oficina gubernamental', '濯': 'colada', '因': 'causa', '許': 'permitir', '磨': 'pulir', '忙': 'ocupado', '悦': 'éxtasis', '志': 'intención', '串': 'pinchito', '憎': 'odio', '悟': 'iluminación', '忠': 'lealtad', '応': 'adaptar', '悔': 'arrepentimiento', '悼': 'lamento', '想': 'concepto', '恒': 'constancia', '惑': 'engatusar', '寡': 'viuda', '誌': 'documento', '恐': 'terror', '息': 'respiración', '忍': 'aguante', '患': 'afligido', '恩': 'gracia', '忌': 'velatorio', '憩': 'pausa', '憂': 'melancolía', '恵': 'favor', '意': 'idea', '認': 'reconocer', '怖': 'miedo', '感': 'emoción', '思': 'pensar', '慌': 'desconcierto', '添': 'anexo', '憾': 'remordimiento', '摩': 'rozar', '抄': 'extracto', '抹': 'frotar', '愉': 'placer', '搭': 'embarcar', '慕': 'ansia', '看': 'vigilar', '憶': 'recuerdo', '抱': 'abrazo', '拍': 'aplaudir', '拓': 'despejar (el terreno)', '招': 'invitar', '泌': 'rezumar', '打': 'golpear', '手': 'mano', '拘': 'arrestar', '必': 'necesariamente', '慣': 'costumbre', '我': 'ego', '犠': 'sacrificio', '批': 'crítica', '義': 'virtud', '議': 'deliberación', '抗': 'confrontación', '惰': 'pereza', '慎': 'humildad', '揚': 'enarbolar', '接': 'tocar', '鼻': 'nariz', '械': 'artilugio', '提': 'propuesta', '戒': 'mandamiento', '担': 'llevar sobre los hombros', '財': 'propiedad', '刑': 'castigar', '存': 'suponer', '拠': 'apoyo', '推': 'conjetura', '才': 'genio', '持': 'sostener', '摘': 'pellizcar', '損': 'daño', '描': 'bosquejar', '括': 'sujetar', '揮': 'blandir', '掛': 'colgar', '型': 'molde', '拾': 'recoger', '挑': 'desafío', '指': 'dedo', '操': 'pilotar', '捨': 'descartar', '研': 'bruñir', '在': 'existir', '材': 'material', '掲': 'subir', '拐': 'secuestrar', '隻': 'bajeles', '及': 'alcanzar', '護': 'custodiar', '抜': 'zafarse', '吸': 'chupar', '丈': 'metraje', '友': 'amigo', '更': 'renovar', '投': 'lanzar', '怒': 'ira', '硬': 'rígido', '奴': 'tipejo', '枝': 'leño', '技': 'pericia', '殻': 'cáscara', '設': 'establecimiento', '肢': 'extremidad', '支': 'rama', '吏': 'funcionario', '扱': 'manejar', '双': 'par', '史': 'historia', '撃': 'azotar', '桑': 'morera', '又': 'o bien', '乃': 'a partir de', '獲': 'obtener', '携': 'portátil', '没': 'ahogarse', '茎': 'tallo', '拡': 'ampliar', '寂': 'soledad', '督': 'entrenador', '爪': 'garras', '返': 'devolver', '広': 'ancho', '雄': 'macho', '授': 'impartir', '叔': 'tío', '浮': 'flotar', '乳': 'leche', '採': 'recolectar', '台': 'pedestal', '販': 'marketing', '軽': 'liviano', '反': 'anti-', '愛': 'amor', '淑': 'grácil', '将': 'líder', '弁': 'válvula', '受': 'aceptar', '治': 'reinar', '奨': 'exhortar', '怠': 'descuidar', '板': 'tabla', '怪': 'sospechoso', '妥': 'amable', '坂': 'pendiente', '払': 'pagar', '菜': 'verdura', '鉱': 'mineral', '岐': 'bifurcación', '硫': 'azufre', '崩': 'derrumbarse', '山': 'montaña', '撤': 'eliminar', '始': 'empezar', '到': 'llegada', '去': 'pasado', '峠': 'cima de la montaña', '密': 'oculto', '銃': 'fusil', '致': 'facer', '蜜': 'miel', '育': 'educar', '拙': 'torpe', '炭': 'carbón', '充': 'asignar', '互': 'mutuamente', '流': 'corriente', '允': 'licencia', '室': 'sala', '至': 'clímax', '出': 'salir', '岩': 'roca', '法': 'método', '胎': 'matriz', '会': 'reunión', '唆': 'cautivar', '窓': 'ventana', '棄': 'abandonar', '分': 'parte', '鉛': 'plomo', '裕': 'abundante', '容': 'contener', '貧': 'pobreza', '堂': 'sala pública', '裳': 'falda', '浴': 'bañarse', '公': 'público', '翁': 'anciano venerable', '嵐': 'tormenta', '披': 'exponer', '松': 'pino', '婆': 'abuelita', '党': 'partido', '賞': 'premio', '沿': 'circunvalar', '欲': 'anhelo', '込': 'aglomeración', '溶': 'derretir', '谷': 'valle', '常': 'normal', '崎': 'promontorio', '皮': 'pellejo', '被': 'incurrir', '頒': 'partición', '訟': 'querellarse', '破': 'desgarrar', '掌': 'manipular', '入': 'entrar', '波': 'olas', '敢': 'osadía', '最': 'máximo', '殖': 'multiplicarse', '撮': 'tomar fotos', '漫': 'suelto', '耳': 'oreja', '濁': 'turbio', '殊': 'particularmente', '烈': 'ardiente', '環': 'anillo', '残': 'el resto', '裂': 'ruptura', '葬': 'funeral', '聴': 'escuchar', '恥': 'vergüenza', '買': 'comprar', '列': 'hilera', '趣': 'lo esencial', '死': 'muerte', '置': 'colocar', '懐': 'bolsillo', '殉': 'martirio', '職': 'puesto', '還': 'mandar de vuelta', '罰': 'reprender', '寧': 'más bien', '取': 'tomar', '聖': 'sagrado', '瞬': 'pestañeo', '慢': 'ridículo', '功': 'éxito', '臓': 'entrañas', '姫': 'princesa', '加': 'añadir', '渓': 'arroyo de montaña', '臣': 'criado', '規': 'estándar', '励': 'animar', '鉄': 'hierro', '募': 'reclutar', '臨': 'expectación', '劣': 'inferioridad', '夫': 'marido', '蔵': 'almacén', '失': 'perder', '労': 'fatiga', '潜': 'sumergir', '賛': 'estar de acuerdo', '替': 'canje', '賢': 'inteligente', '扶': 'asistencia', '拒': 'repeler', '勧': 'persuadir', '努': 'esfuerzo', '覧': 'ojear', '力': 'fuerza', '堅': 'estricto', '巨': 'gigantesco', '男': 'varón', '迭': 'alternar', '徹': 'penetrar', '徳': 'benevolencia', '賀': 'felicitaciones', '役': 'función', '従': 'seguir', '稿': 'borrador', '往': 'trayecto', '得': 'ganancia', '脇': 'axila', '脅': 'amenaza', '懲': 'penal', '協': 'co-', '衡': 'equilibrio', '征': 'subyugar', '彼': 'él', '税': 'impuesto', '復': 'restaurar', '徴': 'indicios', '待': 'esperar', '徒': 'alumno', '架': 'erigir', '行': 'ir', '微': 'delicado', '街': 'bulevar', '律': 'rítmico', '稼': 'ingresos', '径': 'diámetro', '程': 'alcance', '秘': 'secreto', '委': 'comité', '秒': 'segundo', '愁': 'tristeza', '穫': 'cosecha', '菌': 'germen', '移': 'trasladar', '稲': 'planta del arroz', '秋': 'otoño', '香': 'incienso', '季': 'estaciones del año', '粒': 'granos', '穂': 'espiga', '梨': 'peral', '誘': 'tentar', '利': 'beneficio', '透': 'transparente', '穀': 'cereales', '称': 'apelación', '秀': 'sobresaliente', '私': 'privado', '粘': 'pegajoso', '米': 'arroz', '粧': 'cosmético', '稚': 'inmaduro', '粉': 'harina', '秩': 'regularidad', '和': 'armonía', '迷': 'desviación', '類': 'tipo de', '求': 'solicitud', '人': 'persona', '筒': 'cilindro', '笑': 'risa', '算': 'calcular', '漆': 'laca', '策': 'estratagema', '築': 'fabricar', '救': 'salvación', '様': 'don', '菊': 'crisantemo', '笠': 'sombrero de bambú', '粋': 'chic', '糧': 'provisiones', '佐': 'asistente', '答': 'solución', '筆': 'pincel de escritura', '筋': 'músculo', '球': 'balón', '等': 'etc.', '箱': 'caja', '竹': 'bambú', '楼': 'atalaya', '笹': 'bambú enano', '但': 'sin embargo', '奥': 'hondura', '数': 'número', '簿': 'registrar', '依': 'confiar', '仏': 'Buda', '佳': 'excelente', '健': 'saludable', '僧': 'monje budista', '位': 'rango', '件': 'caso', '住': 'habitar', '仮': 'provisional', '停': 'parada', '伯': 'conde', '伏': 'postrado', '偵': 'espiar', '値': 'precio', '信': 'fe', '体': 'cuerpo', '他': 'otro', '仕': 'atender', '侍': 'camarero', '休': 'descanso', '悠': 'remoto', '側': 'lado', '倣': 'emular', '例': 'ejemplo', '倒': 'derrocamiento', '俗': 'vulgar', '仲': 'intermediario', '伝': 'transmitir', '個': 'individual', '仁': 'humanitario', '符': 'símbolo', '億': 'cien millones', '償': 'indemnización', '褒': 'alabar', '袋': 'saco', '傷': 'herida', '保': 'conservar', '伐': 'talar', '仙': 'ermitaño', '貸': 'prestar', '傑': 'grandeza', '賃': 'paga', '使': 'usar', '催': 'anfitrión', '儀': 'ceremonia', '付': 'adherir', '宿': 'hostal', '侮': 'mofarse', '任': 'responsabilidad', '便': 'conveniencia', '優': 'ternura', '化': 'cambio', '代': 'sustituto', '花': 'flor', '府': 'municipio', '倍': 'doble', '併': 'juntar', '年': 'año', '内': 'dentro', '貨': 'carga', '似': 'semejante', '傾': 'inclinar', '瓦': 'teja', '以': 'por medio de', '丙': 'tercera clase', '柄': 'diseño', '営': 'ocupación', '腐': 'podrirse', '畝': 'surco', '久': 'duradero', '肉': 'carne', '宮': 'templo sintoísta', '善': 'bondad', '何': 'qué', '俊': 'sagaz', '傍': 'mirón', '卒': 'graduarse', '座': 'sentarse', '囚': 'capturado', '荷': 'equipaje', '傘': 'paraguas', '瓶': 'florero', '匁': 'monme', '喚': 'alarido', '夜': 'vespertino', '液': 'líquido', '履': 'calzado', '掘': 'excavar', '塚': 'montículo', '尿': 'orina', '賜': 'otorgar', '握': 'asir', '施': 'limosna', '弊': 'abuso', '屋': 'tejado', '換': 'intercambio', '堀': 'zanja', '幣': 'en metálico', '塀': 'cercado', '旋': 'rotación', '融': 'disolver', '居': 'residir', '勿': 'no', '易': 'fácil', '泥': 'barro', '遊': 'jugar', '物': 'cosa', '尼': 'monja', '旅': 'viaje', '屈': 'ceder', '祥': 'favorable', '顧': 'mirar atrás', '昼': 'de día', '肩': 'hombro', '啓': 'manifestar', '房': 'borla', '遅': 'lento', '尽': 'agotar', '尺': 'shaku', '示': 'mostrar', '戻': 'volver', '涙': 'lágrima', '祝': 'celebrar', '局': 'oficina', '沢': 'ciénaga', '雇': 'contratar', '択': 'escoger', '層': 'estrato', '戸': 'puerta', '漏': 'filtración', '礼': 'saludo', '炉': 'lar', '据': 'establecer', '扇': 'ventilador', '訳': 'traducir', '刷': 'imprimir', '油': 'aceite', '禁': 'prohibición', '軸': 'eje', '視': 'inspección', '宙': 'espacio', '抽': 'extraer', '祭': 'festividad', '襟': 'cuello de la camisa', '崇': 'adorar', '岬': 'lengua de tierra', '福': 'bendición', '奈': 'Nara', '笛': 'silbato', '宗': 'religión', '挿': 'insertar', '擦': 'rallar', '袖': 'manga', '察': 'estimación', '款': 'buena voluntad', '社': 'empresa', '尉': 'oficial militar', '甲': 'coraza', '押': 'empujar', '届': 'repartir', '慰': 'consuelo', '祉': 'bienestar', '由': 'por lo que', '詐': 'mentira', '果': 'fruta', '逝': 'expirar', '斥': 'rechazar', '雪': 'nieve', '作': 'realizar', '析': 'tronchar', '漸': 'gradualmente', '神': 'dioses', '誓': 'juramento', '斤': 'hacha', '伸': 'expandir', '折': 'plegar', '断': 'recortar', '訴': 'acusación', '申': 'tomar la palabra', '裸': 'desnudo', '暫': 'temporalmente', '菓': 'caramelo', '近': 'cerca', '昨': 'ayer', '祈': 'orar', '所': 'sitio', '質': 'sustancia', '課': 'capítulo', '哲': 'filosofía', '捜': 'buscar', '群': 'manada', '侵': 'invadir', '君': 'tú', '唐': 'Tang', '掃': 'barrer', '糖': 'azúcar', '儒': 'confuciano', '需': 'demanda', '端': 'margen', '満': 'lleno', '穏': 'calma', '争': 'contienda', '急': 'apresurarse', '寝': 'yacer', '逮': 'aprehender', '耐': 'a prueba de', '浸': 'inmersión', '浄': 'limpio', '伊': 'Italia', '婦': 'señora', '画': 'trazo de pincel', '事': 'asunto', '当': 'acertar', '両': 'ambos', '尋': 'encuesta', '康': 'sano', '録': 'grabar', '庶': 'plebeyo', '料': 'importe', '措': 'apartar', '昔': 'érase una vez', '用': 'utilizar', '曲': 'doblegar', '遮': 'interceptar', '度': 'grado', '噴': 'erupción', '備': 'equipamiento', '錯': 'confuso', '曹': 'cadete', '歯': 'diente', '奔': 'bullicio', '渡': 'cruzar', '科': 'departamento', '遭': 'encuentro', '槽': 'tinaja', '借': 'tomar prestado', '廿': 'veinte', '庸': 'confortable', '席': 'asiento', '漕': 'remar', '散': 'esparcer', '惜': 'pena', '斗': 'Osa Mayor', '図': 'mapa', '知': 'saber', '杯': 'una taza de', '券': 'boleto', '否': 'negar', '暁': 'alba', '焼': 'freír', '謄': 'facsímil', '乏': 'destitución', '墳': 'sepulcro', '芝': 'césped', '半': 'mitad', '巻': 'pergamino', '勝': 'victoria', '智': 'sabiduría', '矯': 'rectificar', '之': 'de', '憤': 'indignación', '矢': 'dardo', '不': 'negativo', '判': 'sentencia', '畔': 'borde de un arrozal', '族': 'tribu', '版': 'bloque de imprenta', '圏': 'esfera', '伴': 'consorte', '藤': 'glicina', '片': 'un lado', '帰': 'volver a casa', '汚': 'sucio', '朽': 'decadencia', '矛': 'alabarda', '身': 'alguien', '誇': 'jactarse', '写': 'copiar', '柔': 'tierno', '与': 'conceder', '班': 'brigada', '弘': 'extenso', '老': 'anciano', '弓': 'arco', '務': 'tarea', '弱': 'débil', '引': 'tirar', '強': 'fuerte', '号': 'apodo', '沸': 'hervir', '第': 'Núm.', '費': 'gastos', '弟': 'hermano menor', '弔': 'pésame', '霧': 'niebla', '謝': 'disculparse', '射': 'disparar', '巧': 'habilidad', '較': 'contraste', '渚': 'ribera', '追': 'perseguir', '賭': 'apostar', '猪': 'jabalí', '峡': 'desfiladero', '孝': 'devoción filial', '狭': 'estrecho', '煮': 'cocer', '者': 'alguno', '官': 'burócrata', '師': 'experto', '暑': 'bochorno', '教': 'enseñar', '校': 'escuela', '考': 'considerar', '効': 'mérito', '父': 'padre', '挟': 'intercalar', '拷': 'tortura', '署': 'firma', '諸': 'diversos', '交': 'entremezclar', '著': 'célebre', '帥': 'comandante', '管': 'cañería', '棺': 'ataúd', '躍': 'salto', '陽': 'luz del sol', '足': 'pie', '促': 'estimular', '跳': 'brinco', '随': 'ir detrás', '髄': 'médula', '践': 'pisar', '陳': 'poner en fila', '防': 'defenderse de', '渦': 'remolino', '阪': 'Alto', '禍': 'calamidad', '際': 'ocasión', '滑': 'resbaladizo', '路': 'sendero', '附': 'acoplado', '阿': 'África', '院': 'Institución', '距': 'larga distancia', '過': 'demasiado', '障': 'obstruir', '骨': 'esqueleto', '踏': 'paso', '陪': 'auxiliar', '露': 'rocío', '窒': 'obturar', '降': 'descender', '窯': 'horno', '陣': 'campamento', '控': 'retener', '丘': 'cerro', '空': 'vacío', '堕': 'degenerar', '突': 'punzar', '階': 'piso', '岳': 'colina', '隊': 'regimiento', '探': 'tantear', '窮': 'paupérrimo', '深': 'profundo', '搾': 'estrujar', '究': 'indagación', '兵': 'soldado', '隣': 'vecino', '隔': 'aislar', '窃': 'sigiloso', '穴': 'agujero', '窪': 'depresión', '陛': 'alteza', '墜': 'caída', '隠': 'encubrir', '陥': 'colapso', '給': 'salario', '羅': 'gasa', '結': 'atar', '織': 'tejer', '紡': 'hilatura', '絡': 'entrelazar', '線': 'línea', '絞': 'estrangular', '維': 'fibra', '納': 'concluir', '級': 'clase', '紅': 'carmín', '繁': 'lujo', '締': 'estrechar', '繕': 'remendar', '続': 'continuar', '紛': 'perturbar', '統': 'integración', '終': 'final', '縦': 'vertical', '縮': 'encoger', '浜': 'costa', '絵': 'dibujo', '糸': 'hilo', '練': 'practicar', '紀': 'crónica', '緒': 'correa', '紫': 'púrpura', '幾': 'cuántos', '畜': 'ganado', '索': 'cable', '綿': 'algodón', '後': 'detrás', '緑': 'verde', '緊': 'tenso', '継': 'heredar', '総': 'general', '細': 'delgado', '紳': 'caballero', '縛': 'amarrar', '絹': 'seda', '機': 'mecanismo', '網': 'red', '繰': 'enrollado', '幼': 'infancia', '縁': 'afinidad', '縄': 'cuerda de paja', '紹': 'presentar a alguien', '約': 'promesa', '幽': 'impreciso', '経': 'sðtra', '蓄': 'acaudalar', '玄': 'misterioso', '累': 'acumular', '御': 'honorable', '令': 'órdenes', '却': 'al contrario', '孫': 'nieto', '勇': 'coraje', '冷': 'frescura', '弦': 'cuerda de arco', '係': 'encargado', '擁': 'abarcar', '懸': 'suspender', '滋': 'nutritivo', '鈴': 'campanilla', '犯': 'crimen', '疑': 'duda', '脚': 'espinilla', '凝': 'solidificar', '擬': 'imitar', '踊': 'bailar', '卸': 'al por mayor', '範': 'patrón', '零': 'cero', '領': 'jurisdicción', '慈': 'piedad', '磁': 'imán', '齢': 'edad', '系': 'linaje', '通': 'tráfico', '命': 'destino', '服': 'prenda', '尊': 'reverencia', '短': 'corto', '酬': 'recompensar', '留': 'estacionar', '酉': 'signo del pájaro', '酔': 'borracho', '腕': 'brazo', '酌': 'servir sake', '猶': 'vacilar', '貿': 'comerciar', '頭': 'cabeza', '危': 'peligroso', '酷': 'crueldad', '豆': 'alubias', '柳': 'sauce', '厄': 'mala suerte', '印': 'sello', '卵': 'huevo', '配': 'distribuir', '苑': 'jardín', '興': 'entretener', '酵': 'fermentación', '宛': 'dirección postal', '豊': 'provechoso', '怨': 'rencor', '酪': 'productos lácteos', '酢': 'vinagre', '鼓': 'tambor', '酒': 'sake', '酸': 'ácido', '爵': 'barón', '濫': 'desbordarse', '盗': 'robar', '盛': 'auge', '盆': 'cuenca', '銀': 'plata', '恨': 'resentimiento', '血': 'sangre', '節': 'nódulo', '飯': 'comida', '皿': 'plato', '即': 'instantáneo', '食': 'comer', '朗': 'melodioso', '浪': 'errante', '喜': 'alegría', '飢': 'hambriento', '娘': 'hija', '眼': 'globo ocular', '限': 'confín', '退': 'retirada', '監': 'supervisar', '鑑': 'espécimen', '飲': 'beber', '樹': 'árboles madereros', '盟': 'alianza', '良': 'bueno', '猛': 'fiero', '根': 'raíz', '塩': 'sal', '温': 'caliente', '概': 'aproximadamente', '飾': 'decorar', '坪': 'área de dos esteras', '館': 'Edificio', '凶': 'villano', '鈍': 'embotado', '新': 'nuevo', '梓': 'catalpa', '離': 'desprenderse', '幸': 'felicidad', '純': 'genuino', '胸': 'pecho', '親': 'progenitor', '薪': 'leña', '飽': 'harto', '壁': 'pared', '評': 'evaluación', '養': 'fomentar', '餓': 'inanición', '避': 'refugiarse', '殺': 'matar', '希': 'esperanza', '辞': 'dimitir', '慨': 'deplorar', '既': 'previamente', '辛': 'picante', '刈': 'segar', '宰': 'administrar', '呼': 'llamar', '平': 'llano', '嬢': 'muchacha', '陸': 'terrestre', '劾': 'denunciar', '精': 'refinado', '糾': 'retorcer', '述': 'mencionar', '術': 'arte', '麦': 'cebada', '請': 'solícito', '醸': 'destilación', '青': 'azul', '菱': 'diamante', '素': 'elemental', '壌': 'parcela', '碑': 'lápida', '執': 'tenaz', '叫': 'grito', '寒': 'frío', '該': 'mencionado anteriormente', '刻': 'cincelar', '報': 'informe', '核': 'núcleo', '譲': 'deferencia', '亥': 'signo del jabalí', '毒': 'veneno', '卑': 'despreciable', '収': 'rentas', '睦': 'íntimo', '陵': 'mausoleo', '勢': 'fuerzas', '熱': 'calor', '割': 'proporción', '責': 'inculpar', '生': 'vida', '喫': 'consumir', '績': 'hazaña', '静': 'apacible', '星': 'estrella', '晴': 'despejado', '契': 'compromiso', '隆': 'giba', '債': 'fianza', '拝': 'venerar', '憲': 'constitución', '轄': 'control', '表': 'superficie', '産': 'producción', '姓': 'apellido', '峰': 'cumbre', '俵': 'bolsa', '牲': 'sacrificio animal', '潔': 'inmaculado', '漬': 'escabeche', '情': 'sentimientos', '害': 'damnificar', '縫': 'coser', '清': 'puro', '性': 'sexo', '積': 'volumen', '念': 'deseo', '春': 'primavera', '奉': 'dedicar', '乗': 'montar', '華': 'esplendor', '椿': 'camelia', '今': 'ahora', '剰': 'exceso', '吟': 'versificar', '棒': 'cayado', '嘆': 'suspiro', '鋳': 'fundir', '籍': 'inscribirse', '勤': 'diligencia', '泰': 'pacífico', '寿': 'longevidad', '奏': 'tocar música', '謹': 'discreto', '実': 'realidad', '俸': 'estipendio', '睡': 'somnoliento', '難': 'difícil', '含': 'incluir', '錘': 'huso', '垂': 'pender', '漢': 'Sino-', '標': 'señal', '遷': 'transición', '票': 'voto', '廉': 'ganga', '栗': 'castaño', '謙': 'modesto', '陰': 'penumbra', '門': 'verja', '野': 'llanura', '兼': 'al mismo tiempo', '預': 'depósito', '序': 'prefacio', '漂': 'a la deriva', '南': 'sur', '予': 'de antemano', '価': 'valor', '鎌': 'hoz', '要': 'necesitar', '嫌': 'desagradar', '煙': 'humo', '腰': 'caderas', '楠': 'alcanforero', '献': 'donación', '琴': 'arpa', '問': 'pregunta', '覆': 'volcar', '西': 'oeste', '潤': 'mojado', '開': 'abierto', '閲': 'pasar revista', '俳': 'haiku', '輩': 'camarada', '侯': 'marqués', '簡': 'sencillo', '倉': 'granero', '罪': 'culpabilidad', '違': 'diferencia', '排': 'repudiar', '非': 'sin', '偉': 'admirable', '閣': 'torre', '聞': 'oír', '間': 'intervalo', '快': 'alegre', '決': 'decidir', '闘': 'lucha', '扉': 'puerta principal', '欄': 'columna tipográfica', '悲': 'triste', '閥': 'camarilla', '創': 'génesis', '候': 'clima', '閉': 'cerrado', '閑': 'ocio', '途': 'ruta', '余': 'excesivo', '整': 'organizar', '徐': 'progresivamente', '叙': 'conferir', '肝': 'hígado', '勅': 'orden imperial', '頼': 'confianza', '塗': 'pintura', '束': 'manojo', '刊': 'publicación', '韓': 'Corea', '宇': 'universo', '速': 'rápido', '軒': 'alero', '緯': 'horizontal', '衛': 'defensa', '除': 'excluir', '汗': 'sudor', '干': 'secar', '幹': 'tronco del árbol', '岸': 'playa', '斜': 'diagonal', '瀬': 'rápidos', '剣': 'sable', '芋': 'patata', '疎': 'enajenar', '働': 'trabajar', '疫': 'epidemia', '検': 'test', '枢': 'bisagra', '痘': 'viruela', '症': 'síntomas', '険': 'escarpado', '勲': 'proeza meritoria', '痢': 'diarrea', '匿': 'esconderse', '倹': 'frugal', '重': 'pesado', '動': 'mover', '薫': 'fragante', '医': 'médico', '癖': 'tic', '匠': 'artesano', '疲': 'cansado', '痛': 'dolor', '衝': 'chocar', '種': 'especie', '痴': 'estúpido', '匹': 'igual', '疾': 'raudamente', '病': 'enfermo', '区': 'distrito', '澄': 'resplandeciente', '膨': 'hincharse', '迎': 'bienvenido', '惨': 'desventurado', '僚': 'colega', '形': 'forma', '寮': 'residencia', '診': 'chequeo', '廃': 'abolición', '療': 'terapia', '欧': 'Europa', '修': 'disciplina', '殴': 'asalto', '抑': 'reprimir', '発': 'partida', '杉': 'cedro', '顔': 'cara', '彩': 'colorear', '参': 'presenciar', '彫': 'esculpir', '彰': 'patente', '影': 'sombra', '須': 'deber', '彦': 'chico', '珍': 'raro', '登': 'ascender', '仰': 'boca arriba', '済': 'terminar', '恋': 'romance', '対': 'frente a frente', '渋': 'astringente', '粛': 'solemne', '斉': 'simétrico', '蛮': 'bárbaro', '文': 'oración', '蚊': 'mosquito', '央': 'centro', '跡': 'rastro', '斎': 'purificación', '剤': 'dosis', '率': 'porcentaje', '英': 'Inglaterra', '摂': 'delegado', '赦': 'perdón', '楽': 'música', '赤': 'rojo', '変': 'insólito', '塁': 'bases', '薬': 'medicina', '湾': 'golfo', '映': 'reflejar', '紋': 'blasón familiar', '黄': 'amarillo', '甚': 'enormemente', '組': 'asociación', '無': 'nada', '勘': 'intuición', '堪': 'resistir', '紺': 'azul marino', '謀': 'conspirar', '色': 'color', '旗': 'bandera nacional', '舞': 'revoltear', '甘': 'dulce', '貴': 'precioso', '把': 'agarrar', '棋': 'trebejo', '某': 'fulanito de tal', '碁': 'go', '遣': 'despachar', '絶': 'discontinuo', '期': 'período', '肥': 'fertilizante', '遺': 'legar', '粗': 'burdo', '艶': 'satinado', '欺': 'timo', '横': 'de soslayo', '基': 'cimientos', '祖': 'antepasado', '媒': 'mediador', '租': 'tarifa', '湿': 'húmedo', '暴': 'explosión', '港': 'puerto', '囲': 'rodear', '畳': 'estera tatami', '顕': 'manifiesto', '共': 'juntos', '恭': 'cortesía', '譜': 'partitura', '阻': 'estorbo', '僕': 'servidor', '並': 'fila', '殿': 'Sr.', '異': 'singular', '洪': 'anegar', '宜': 'saludos cordiales', '査': 'investigar', '業': 'profesión', '爆': 'bomba', '選': 'elección', '助': 'ayuda', '供': 'entregar', '霊': 'espíritu', '耕': 'labrar', '繊': 'esbelto', '普': 'universal', '井': 'pozo', '翼': 'ala', '撲': 'abofetear', '底': 'fondo', '構': 'postura', '編': 'recopilación', '抵': 'rebatir', '眠': 'dormir', '浦': 'bahía', '悪': 'malo', '遍': 'omnipresente', '冊': 'tomo', '購': 'suscripción', '典': 'código', '円': 'círculo', '氏': 'nombre de familia', '婚': 'casarse', '亜': 'Asia', '紙': 'papel', '捕': 'capturar', '講': 'conferencia', '蒲': 'anea', '民': 'gente', '偏': 'parcialidad', '再': 'de nuevo', '輪': 'rueda', '溝': 'canal', '倫': 'ética', '触': 'contacto', '解': 'solucionar', '角': 'ángulo', '低': 'rebajar', '論': 'argumento', '廊': 'pasillo', '部': 'sección', '鍛': 'forjar', '衆': 'muchedumbre', '脈': 'vena', '幻': 'fantasma', '郊': 'afueras', '飼': 'domesticar', '詞': 'categoría gramatical', '逓': 'servicio postal', '郵': 'correo', '郡': 'comarca', '盾': 'escudo', '郷': 'tierra natal', '循': 'secuencial', '郭': 'contorno', '嗣': 'sucesor', '派': 'facción', '伺': 'presentar sus respetos', '舗': 'comercio', '響': 'eco', '司': 'director', '都': 'metrópolis', '補': 'suplemento', '后': 'emperatriz', '郎': 'hijo', '段': 'gradación', '邸': 'mansión', '邦': 'patria', '舟': 'bote', '来': 'venir', '飛': 'volar', '暇': 'tiempo libre', '妻': 'esposa', '気': 'energía', '舶': 'buque mercante', '靴': 'zapatos', '声': 'voz', '航': 'navegar', '盤': 'bandeja', '艇': 'barca de remos', '艦': 'acorazado', '沈': 'hundirse', '汽': 'vapor', '繭': 'capullo', '搬': 'acarrear', '衷': 'interior', '船': 'barco', '衰': 'declive', '瓜': 'melón', '面': 'máscara', '覇': 'hegemonía', '弧': 'curvatura', '般': 'carguero', '益': 'rédito', '敷': 'extender', '孤': 'huérfanof', '革': 'cuero', '函': 'cajón', '脹': 'dilatar', '牙': 'colmillo', '髪': 'pelo', '娯': 'diversión', '蒸': 'vaho', '長': 'largo', '極': 'polos', '誤': 'error', '尾': 'cola de animal', '展': 'desarrollar', '偽': 'falsedad', '番': 'turno', '帳': 'cuaderno de apuntes', '呉': 'dar', '雅': 'elegante', '耗': 'gastar', '毛': 'pelaje', '為': 'hacer', '宅': 'domicilio', '承': 'consentir', '翻': 'voltear', '審': 'vista', '芽': 'germinar', '託': 'consignar', '張': 'alargar', '釈': 'explicación', '藩': 'clan', '邪': 'infame', '桜': 'cerezo', '烏': 'cuervo', '巣': 'nido', '鳩': 'paloma', '鳴': 'piar', '鶴': 'grulla', '猟': 'cacería', '媛': 'bella mujer', '弾': 'bala', '厳': 'severo', '戦': 'guerra', '鳥': 'pájaro', '獣': 'animal', '嘱': 'encomendar', '偶': 'por casualidad', '援': 'socorro', '島': 'isla', '属': 'pertenecer', '禅': 'zen', '誉': 'reputación', '単': 'simple', '悩': 'inquietud', '緩': 'flojear', '鎖': 'cadena', '鶏': 'gallina', '暖': 'calidez', '挙': 'alzar', '脳': 'cerebro', '喪': 'luto', '蔦': 'parra', '験': 'verificación', '缶': 'lata', '懇': 'sociable', '揺': 'mecerse', '免': 'excusarse', '隅': 'esquina', '謡': 'canción de nõ', '象': 'elefante', '墾': 'abrir tierras', '愚': 'alocado', '像': 'estatua', '遇': 'entrevista', '塑': 'modelar', '晩': 'crepúsculo', '逸': 'eludir', '駒': 'potro', '剛': 'vigoroso', '勉': 'ejercer', '就': 'concerniente a', '綱': 'soga', '陶': 'alfarería', '鋼': 'acero', '馬': 'caballo', '逆': 'invertido', '岡': 'Monte', '篤': 'ferviente', '寅': 'signo del tigre', '慮': 'prudencia', '虚': 'vacuo', '騰': 'inflación', '戯': 'jolgorio', '鹿': 'ciervo', '駄': 'oneroso', '熊': 'oso', '麗': 'hermoso', '騎': 'ecuestre', '態': 'actitud', '虜': 'cautivo', '駆': 'conducir', '慶': 'jubilación', '駐': 'aparcar', '膚': 'dermis', '薦': 'recomendar', '劇': 'drama', '虐': 'opresión'}
...
AllKanji = ShouGaku1Nen + ShouGaku2Nen + ShouGaku3Nen + ShouGaku4Nen + ShouGaku5Nen + ShouGaku6Nen + ChuuGaku1Nen + ChuuGaku2Nen + ChuuGaku3Nen + Added2010
...
Mprefs = lambda: {"kanjiNum": 0, "studyToday": 0, "beginDate": datetime.date.today().strftime("%Y/%m/%d"), "lostKanji": 0}
MainPrefs = PREFS.PREFS(prefs = Mprefs, filename = "DailyDoseOfKanjis_Prefs")

Kprefs = {"ShouGaku1Nen": ShouGaku1Nen, "ShouGaku2Nen": ShouGaku2Nen, "ShouGaku3Nen": ShouGaku3Nen, "ShouGaku4Nen": ShouGaku4Nen, "ShouGaku5Nen": ShouGaku5Nen, "ShouGaku6Nen": ShouGaku6Nen, "ChuuGaku1Nen": ChuuGaku1Nen, "ChuuGaku2Nen": ChuuGaku2Nen, "ChuuGaku3Nen": ChuuGaku3Nen, "Added2010": Added2010, "AllKanji": AllKanji}
KanjiPrefs = PREFS.PREFS(prefs = Kprefs, filename = "KANJIS", interpret = True)
...
class Graphics(object):
	...
	def KanjiGrade(self, grade):
		self.grade = grade
		if grade == "1":
			grade = self.KanjiPrefs.ReadPrefs()["ShouGaku1Nen"]
		elif grade == "2":
			grade = self.KanjiPrefs.ReadPrefs()["ShouGaku2Nen"]
		elif grade == "3":
			grade = self.KanjiPrefs.ReadPrefs()["ShouGaku3Nen"]
		elif grade == "4":
			grade = self.KanjiPrefs.ReadPrefs()["ShouGaku4Nen"]
		elif grade == "5":
			grade = self.KanjiPrefs.ReadPrefs()["ShouGaku5Nen"]
		elif grade == "6":
			grade = self.KanjiPrefs.ReadPrefs()["ShouGaku6Nen"]
		elif grade == "Int 1":
			grade = self.KanjiPrefs.ReadPrefs()["ChuuGaku1Nen"]
		elif grade == "Int 2":
			grade = self.KanjiPrefs.ReadPrefs()["ChuuGaku2Nen"]
		elif grade == "Int 3":
			grade = self.KanjiPrefs.ReadPrefs()["ChuuGaku3Nen"]
		elif grade == "Added in 2010":
			grade = self.KanjiPrefs.ReadPrefs()["Added2010"]
		elif grade == "All Kanjis":
			grade = self.KanjiPrefs.ReadPrefs()["AllKanji"]
		...
		box = []
		for x in range(15, 2142, yChange):
		...
		if hideOrShow == "show":
			...
			if what == "config":
				if self.scene != "config":
					...
					y = 530
					e = 0
					for i in range(len(self.dailyKanjisConfigEntries)):

						self.dailyKanjisConfigEntries[i].place(x = x, y = y, anchor = "n")
						self.dailyKanjisConfigText[i].place(x = x, y = y - 30, anchor = "center")
			...
			if what == "menu":
				...
				if self.configCount > 0:
					if self.scene != "menu":
						destroy(self.configButton)
					for i in self.dailyKanjisConfigEntries:
						destroy(i)
					for i in self.dailyKanjisConfigText:
						destroy(i)

						destroy(self.SaveButton)

	def SaveConfig(self):
		text = self.dailyKanjisConfigEntries[0].get()

		for i in range(2142):
			if text != "0-2141" and int(text) == i:
				MainPrefs.WritePrefs("kanjiNum", int(text))
	...
	def Config(self):
		...
		#Daily kanjis config
		self.dailyKanjisConfigEntries = []
		self.dailyKanjisConfigText = []

		font = Font("none", "15", "bold", "roman")
		
		width = 20
		height = 2

		e = 0
		for i in ["Kanjis studied"]:
			self.dailyKanjisConfigText.append(tkinter.Label(self.window, text = i, height = 1, bg = "#f2f2f4", fg = "#2c2c2c", font = font))
			#destroy(self.dailyKanjisConfigText[e])

			self.dailyKanjisConfigEntries.append(EntryWithPlaceholder(self.window, "0-2141"))
			#destroy(self.dailyKanjisConfigEntries[e])
	...
	def key_pressed(self, event):
		if self.configCount > 0:
			print(self.dailyKanjisConfigEntries[0].get())
		if event.keycode == 9:
			if self.scene == "menu":
				self.window.destroy()
...
def CompareDailyKanji():
	global MainPrefs

	compareDate = MainPrefs.ReadPrefs()["compareDate"]
...
def DailyKanji(difference):
	...
	try:
		for i in range(beginKanji, endKanji):
			result += KanjiPrefs.ReadPrefs()["AllKanji"][i]
	except IndexError:
		result = "finished"
