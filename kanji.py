...
AllKanjiList = []
AllKanjiList.append(ShouGaku1Nen)
AllKanjiList.append(ShouGaku2Nen)
AllKanjiList.append(ShouGaku3Nen)
AllKanjiList.append(ShouGaku4Nen)
AllKanjiList.append(ShouGaku5Nen)
AllKanjiList.append(ShouGaku6Nen)

AllKanjiList.append(ChuuGaku1Nen)
AllKanjiList.append(ChuuGaku2Nen)
AllKanjiList.append(ChuuGaku3Nen)

AllKanjiList.append(Added2010)
...
def GetDate():
    firstDate = "2021/04/14" #Here you have to enter your begin date
